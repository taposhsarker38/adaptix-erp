...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800",
  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "data-[state=selected]:bg-cyan-50 dark:data-[state=selected]:bg-cyan-950/20",
        className
      )}
      {...props}
    />
